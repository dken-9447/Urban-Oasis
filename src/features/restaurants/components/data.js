...
export const directions = [
    ...
    },
    {
        id: 2,
        direction:
            "Combine paprika, onion powder, oregano, cayenne pepper, garlic salt, and black pepper in a small bowl; set aside."
    },
    {
        id: 3,
        direction:
            "Cut the pineapple lengthwise into wedges. Grill pineapple wedges for 4 to 5 minutes on each side."
    },
    {
        id: 4,
        direction:
            "Chop pineapple and combine in a bowl with red onions, cilantro, fresh lime juice, and salt."
    },
    {
        id: 5,
        direction:
            "Shrimp is grilled with a homemade blackened seasoning, and a delicious grilled fresh pineapple salsa tops them off."
    },
    {
        id: 6,
        direction:
